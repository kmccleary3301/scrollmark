...
function parseFollowers(req: { url: string }, res: XMLHttpRequest): FollowersParsed {
...
export const FollowersInterceptor = createModuleInterceptor<FollowersParsed>({
